...
import it.pagopa.swc.smartpos.idpay.view_model.LoginViewModel
...
class LoginFragment : BaseFormFragment<MainActivity>() {
    ...
    override val image: Int get() = R.drawable.logo_blu
    ...
    override fun setupUI() {
        ...
        mainActivity?.onUpdatingView = {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q)
                mainActivity?.viewModel?.foldableManagement?.updateView(
                    this,
                    binding.root,
                    RUiKit.layout.base_form_layout
                )
        }
